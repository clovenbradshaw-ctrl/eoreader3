...
// the perceptual-ingest bridge + faithful-import layer are plain scripts (pure,
// no imports) — copied too. import-structure.js loads first (the bridge uses it).
copyFileSync(join(ROOT, 'import-structure.js'), join(DIST, 'import-structure.js'));
...
<!-- faithful import (window.EOImportStructure) — loads before the bridge -->
<script src="import-structure.js"></script>
