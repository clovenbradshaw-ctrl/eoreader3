...
const RULESETS = [
  ...
  { id: 'convention-proposals', group: 'Chatting & grounding', phase: 'chat', name: 'Convention Proposals', glyph: '✎',
    layer: 'significance', mass: 3, src: 'core pack', installed: true, enabled: true, locked: false, live: true,
    desc: 'When the reading keeps hitting the same friction (a “LABEL: statement” shape no convention consumes, a separator line read as a sentence), the local model may PROPOSE a reading convention — at idle priority, a few turns per session, citing only spans the engine showed it. A proposal is a signal, never a rule: it admits only on independent witnesses (other documents, or your one-tap confirm in the glass box’s Proposals tab). Off ⇒ the model never proposes; friction is still registered.' },
